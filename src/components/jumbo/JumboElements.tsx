...
import { Jumbotron, Media } from '@/payload-types';
import Link from 'next/link';
import { useInterval } from 'usehooks-ts';

interface JumboElementsProps {
  jumbos: Jumbotron[];
  className?: string;
}

const JumboElements = ({ jumbos, className }: JumboElementsProps) => {
