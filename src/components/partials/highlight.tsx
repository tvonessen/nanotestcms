...
const Highlight = ({ variant = "primary" }: HighlightProps) => {
  ...
  return (
    <div
      className={`w-full my-16 py-12 shadow-inner bg-fixed bg-gradient-to-t ${gradient}`}
    >
      <div className="container mx-auto px-8 text-background font-medium">
        ...
        <p className="text-lg">
          ...
          odit exercitationem asperiores nesciunt laudantium corrupti dolor
          voluptatum omnis velit. Accusamus quaerat saepe corrupti dolore non
          architecto culpa, animi nesciunt.
        </p>
      </div>
    </div>
  );
