...
export const productCategories = [
  {
    ...
    description: 'Thermal characterization equipment for TIMs and thermal interface materials.',
  ...
  },
  {
    ...
    description: 'Thermal test equipment for TIMs and thermal interface material.',
